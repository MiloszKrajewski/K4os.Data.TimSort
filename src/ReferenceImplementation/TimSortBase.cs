...
namespace ReferenceImplementation
{
	...
	public abstract class TimSortBase<TList, TItem>
	{
		#region consts
		...
		protected static void ArrayCopyRange(
			TItem[] buffer, int sourceIndex, int targetIndex, int length)
		{
		...
		/// <param name="length">The length.</param>
		protected static void ArrayCopyRange(
			TItem[] source, int sourceIndex, TItem[] target, int targetIndex, int length)
		{
