...
public class QuadSorter<T, TIndexer, TReference, TLessThan>
	...
	where TLessThan: ILessThan<T>
{
	...
	public static void parity_swap_four(TIndexer arr, TReference arr0, TLessThan cmp)
	{
		...
		QuadSortTools.parity_merge_two<
	...
	public static void parity_swap_eight(TIndexer arr, TReference arr0, TLessThan cmp)
	{
		...
		QuadSortTools.parity_merge_four<
			T, PtrIndexer<T>, TIndexer, PtrReference<T>, TReference, TLessThan
		>(swp, swp0, arr, arr0, cmp);
	}
...
//		}
	...
	public static unsafe void quad_sort(TIndexer arr, TReference arr0, int nmemb, TLessThan cmp)
	{
		if (nmemb < 32)
		{
	...
	public static void QuadSort(
		TIndexer arr, TReference lo, TReference hi, TLessThan cmp)
	{
		quad_sort(arr, lo, hi.Dif(lo), cmp);
	}
}